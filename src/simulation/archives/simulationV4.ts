...
class RenderingSystem {
    ...
    public cleanup(): void {
        try {
            // Forcer la perte du contexte WebGL
            ...
            console.warn('Erreur lors du nettoyage du RenderingSystem:', error);
        }
    }
...
export class KiteSimulationV4 {
    ...
    private animate = (): void => {
        // Seulement continuer l'animation si on est en cours d'exécution
        if (this.isRunning) {
     ...
     */
    public cleanup(): void {
        console.log('🧹 Nettoyage de KiteSimulationV4...');
        ...
        if (this.leftLine) {
            this.renderingSystem.removeObject(this.leftLine);
            this.leftLine = null;
        }

        if (this.rightLine) {
            this.renderingSystem.removeObject(this.rightLine);
            this.rightLine = null;
        }

        // Nettoyer le système de rendu
        if (this.renderingSystem) {
            this.renderingSystem.cleanup();
        }

        console.log('✅ KiteSimulationV4 nettoyée');
    }
}
