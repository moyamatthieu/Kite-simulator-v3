...
export class Kite extends THREE.Group {
    ...
    private definePoints(): void {
        ...
        // Alias pour compatibilité (anciens noms → nouveaux noms)
        this.pointsMap.set('AILE_GAUCHE', KiteGeometry.POINTS.BORD_GAUCHE.clone());
        this.pointsMap.set('AILE_DROITE', KiteGeometry.POINTS.BORD_DROIT.clone());
    }
