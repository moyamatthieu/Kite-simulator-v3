...
const CAMERA_INITIAL_POSITION = new THREE.Vector3(3, 5, 12); // Position initiale de la caméra
const CAMERA_LOOK_AT_TARGET = new THREE.Vector3(0, 3, -5);   // Point que la caméra regarde initialement
const ORBIT_CONTROLS_TARGET = new THREE.Vector3(0, 0.5, 0);  // Point autour duquel les contrôles orbitent

// Scène et Lumières
const SCENE_BACKGROUND_COLOR = 0x87ceeb;        // Couleur du ciel (bleu clair)
